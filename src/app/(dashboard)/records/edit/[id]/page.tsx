            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input name="name" value={formData.name} onChange={handleChange} type="text" className="cyber-input w-full pl-10" required />
                </div>
              </div>
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input name="alias" value={formData.alias} onChange={handleChange} type="text" className="cyber-input w-full pl-10" />
                </div>
              </div>
              <div className="space-y-2">
